...
int main()
{
    ...
    cout << " by First Causeffectist SHETLM Grandmaster Expert, Saint, Sheikh, Brahman, Rabbi, Shifu, Kru, Sensei, Space Guardian Angel Ibrahim Rammaha.";
    ...
    cout << "John Harvard, Muhammad Ali, Thomas Edison, and for Holy Land from Egyptian Pyramids and Alexandria Library to Syria.";
    ...
    cout << "volcanoes, tornadoes, tsunamis, hurricanes, blackholes? I know what it feels like to be raped and forced to be homeless and robbed as an orphan and made Causeffectism for ";
    cout << "free education providers and orphans to accomplish good things independently and eat evil harmful pleasure enforcers. Getting sick of sodomizers profiting through porn and pedophile gays getting college scholarships.";
    cout << "US made internet and only democracy in world so get ready for new states UNITED STATES OF America, Arabia, Antarctica, Commonwealth Britain, Iran, Zimbabwe, Russia, Malaysia, and Mauritius based on their amazing government policies including punishing sodomy and other crimes. If you are homeless McDonalds, Burger King, Dairy Queen Grill and Chill, Walmart Supermarket, and local storage rental are the cheapest places in America.";
}
