...
public class Welcome {
    ...
    public static void main(String[] args) {
        ...
        greeting[8] = "free education providers and orphans to accomplish good things independently and eat evil harmful pleasure enforcers. Getting sick of sodomizers profiting on porn and pedophile gays getting college scholarships.";
        greeting[9] = "Get ready for UNITED STATES OF ARABIA, North America, Antarctica, Oceania, SOUTH AMERICA, AFRICA, EURASIA, Pacific Islands. If you are homeless McDonalds, Burger King, Dairy Queen Grill and Chill, Walmart Supermarket, and local storage rental are the cheapest places in America.";       
