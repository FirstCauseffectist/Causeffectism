...
public class Welcome {
    ...
    public static void main(String[] args) {
        ...
        greeting[1] = "by First Causeffectist SHETLM Grandmaster Expert, Saint, Sheikh, Brahman, Rabbi, Shifu, Kru, Sensei, Space Guardian Angel Ibrahim Rammaha.";
        ...
        greeting[8] = "free education providers and orphans to accomplish good things independently and eat evil harmful pleasure enforcers. Getting sick of sodomizers profiting through porn and pedophile gays pedophile gays getting funds from government taxes.";
